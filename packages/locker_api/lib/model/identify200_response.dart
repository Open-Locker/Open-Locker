...
class Identify200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Identify200Response &&
    other.name == name &&
    other.type == type &&
  ...
  @override
  String toString() => 'Identify200Response[name=$name, type=$type, apiVersion=$apiVersion, identifier=$identifier, environment=$environment, timestamp=$timestamp]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Identify200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Identify200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Identify200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<Identify200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Identify200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Identify200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
