...
(0, node_test_1.test)('open compartment handler responds success and preserves transaction_id', async () => {
    ...
    const openCompartment = new open_compartment_1.OpenCompartmentUseCase(bus, (0, test_config_repository_1.createTestConfigRepository)(), new scheduler_1.RunAfterCompleteScheduler());
    const pollSnapshot = new state_publishing_1.PollCompartmentStateUseCase(bus, (0, test_config_repository_1.createTestConfigRepository)(), outbound, 'locker/test/state/compartments');
