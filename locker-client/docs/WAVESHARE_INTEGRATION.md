...
- adapter type (`waveshare_modbus`), feedback type, heartbeat interval, and
  compartment mapping are applied via backend `apply_config` and stored
  separately from the base YAML
