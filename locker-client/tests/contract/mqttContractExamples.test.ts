...
const exampleSchemaMappings = [
  ...
  ['event-compartment-open-detected.json', 'payloads/event-compartment-open-detected.json'],
  ['event-compartment-already-open.json', 'payloads/event-compartment-open-detected.json'],
  ['event-compartment-open-failed.json', 'payloads/event-compartment-open-failed.json'],
  ['event-compartment-uncommanded-open.json', 'payloads/event-compartment-uncommanded-open.json'],
