    ...
    'connections' => [
        ...
        'default' => [
            ...
            'logging' => [
                ...
                'channel' => env('MQTT_LOGGING_CHANNEL', 'stack'),
                'level' => env('MQTT_LOGGING_LEVEL', 'info'),
            ],
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'is_secure' => env('MQTT_TLS_IS_SECURE', false),
                    'verify_peer' => env('MQTT_TLS_VERIFY_PEER', true),
                    'ca_file' => env('MQTT_TLS_CA_FILE'),
                    'ca_path' => env('MQTT_TLS_CA_PATH'),
                    'client_cert_file' => env('MQTT_TLS_CLIENT_CERT_FILE'),
                    'client_cert_key_file' => env('MQTT_TLS_CLIENT_CERT_KEY_FILE'),
                    'client_cert_key_passphrase' => env('MQTT_TLS_CLIENT_CERT_KEY_PASSPHRASE'),
                ],
