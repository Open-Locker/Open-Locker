...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Keep the generated backend guideline in this application directory, but
    | place generated skills in the repository's shared backend skill area.
    | Paths are resolved relative to the Laravel application root.
    |
    */
    ...
    'agents' => [
        'cursor' => [
            ...
            'skills_path' => '../.agents/skills/boost',
        ],
        'codex' => [
            'guidelines_path' => 'AGENTS.md',
            'skills_path' => '../.agents/skills/boost',
