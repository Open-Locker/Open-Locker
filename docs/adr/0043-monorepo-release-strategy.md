...
- Superseded in part by:
  ...
  [ADR-0062](0062-component-latest-publishes-newest-component-inputs.md)
  narrows decision 7's backend and locker-client `latest` meaning from exact
  `main` tip to the newest component-relevant `main` state.
